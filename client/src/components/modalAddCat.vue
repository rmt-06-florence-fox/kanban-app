        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex flex-col sm:items-center">
                   <div class="text-center text-white pb-8 text-4xl font-semibold"> Add New Board </div>
                    <form @submit.prevent="addCat" class="space-y-3 w-full text-center" id="formEdit">
...
export default {
    ...
    methods: {
        ...
        addCat() {
            console.log('sudah emit')
            this.$emit('cancelAdd')
            this.$emit('addCat', this.boardName)
        }
    }
}
</script>
