...
export default {
    ...
    methods: {
        ...
        login(email, password) {
            axios({
                method: 'post',
                url: 'https://kanban-app-production-2728.up.railway.app/login',
                data: {
                    email,
                    password
                }
        ...
        register(email, password) {
            axios({
                url:'https://kanban-app-production-2728.up.railway.app/register',
                method:'POST',
                data: {
                    email,
                    password
        ...
        fetchTasks() {
            axios({
                url:'https://kanban-app-production-2728.up.railway.app/tasks',
                method:'GET',
                headers: {
            ...
            this.$swal({
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        return axios({
                            url:`https://kanban-app-production-2728.up.railway.app/tasks/${id}`,
                            method: 'DELETE',
                            headers: {
                                access_token: localStorage.getItem('access_token')
                            }
        ...
        googleSignIn(googleUser) {
            ...
            axios({
                url:`https://kanban-app-production-2728.up.railway.app/googleLogin`,
                method:'POST',
                data: {
