            ...
            <div class="card" draggable="true" v-for="(categoryTask, index) in tasks" :key="index">
                ...
                <div class="container">
                    <div class="deleteTask">
                        <a href="#" @click="deleteToApp(categoryTask.id)" class="text-decoration-none float-right pr-3" >
                ...
                <MoveCategory @moveCategory="moveCategory(category.id)" id="modalMove" :categoryTask="categoryTask.id" > </MoveCategory>   
...
export default {
    ...
    methods:{
        ...
        moveCategory(category){
            console.log(this.categoryTask, '<<< main board <<<<')
